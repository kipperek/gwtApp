...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gwtprojekt" because\n';
  ...
  $wnd.__gwt_activeModules['gwtprojekt'] = {
    'moduleName' : 'gwtprojekt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/gwtprojekt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gwtprojekt'].superdevmode = true;

  var expectedSuffix = '/gwtprojekt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gwtprojekt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gwtprojekt';
  var devModeSessionKey = '__gwtDevModeSession:gwtprojekt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/gwtprojekt/gwtprojekt.nocache.js';
  ...
  $wnd.__gwt_activeModules['gwtprojekt'].canRedirect = true;
  $wnd.__gwt_activeModules['gwtprojekt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gwtprojekt?user.agent=' + ua + '&_callback=' + callback;
